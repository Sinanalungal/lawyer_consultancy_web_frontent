...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({ text, className = '' }) => {
  ...
  return (
    <button 
      onClick={() => login()} 
      type="button" 
      className={`w-full flex my-4 justify-center items-center font-semibold  gap-2  ${className}`} 
    >
