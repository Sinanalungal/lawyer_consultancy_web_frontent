...
const ProfileSection: React.FC<ProfileSectionProps> = ({
  ...
  return (
    <section className="relative  pt-20 ">
      <div className="w-full absolute bg-gradient-to-r from-[#65379B] via-[#886AEA] to-[#6457C6] top-0 left-0 z-0 h-40 object-cover" />
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5">
          <div className="block">
            ...
            <p className="font-normal text-sm leading-7 flex  text-gray-500">
              ...
              sinanalungal012@gmail.com
            </p>
            <p className="font-normal text-sm  flex text-gray-500">
              <p className="font-semibold flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
