...
export default function ImageCarousel({ items: initialItems }: IImageCarouselProps) {
  ...
  return (
    <div className="carousel-container relative h-[500px] w-[600px] overflow-hidden rounded-2xl bg-transparent">
      <div
        onClick={handlePrev}
        className="navigation-item-left absolute left-0 top-[50%] z-20 flex h-10 w-10 translate-y-[-50%] cursor-pointer items-center justify-center rounded-lg "
      >
        <ChevronLeft className="text-gray-800" />
      </div>
      <div
        onClick={handleNext}
        className="navigation-item-right absolute right-0 top-[50%] z-20 flex h-10 w-10 translate-y-[-50%] cursor-pointer items-center justify-center rounded-lg "
      >
