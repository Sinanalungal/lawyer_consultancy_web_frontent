...
const LawyerListing: React.FC = () => {
  ...
  return (
    <section className="min-h-screen mx-auto max-w-7xl ">
      ...
      <div
        className={`sm:w-[98%] border-2 bg-white mx-auto relative rounded-full mb-10  h-12  flex items-center shadow  ${
      ...
      <BlurFade delay={0.25} inView>
        <div className="flex mt-1 relative justify-center  transform ">
          <motion.div
            className={
              openFilter
                ? "absolute p-10 pb-20 mt-1  bg-white shadow-md rounded-xl mx-auto sm:w-[99%] max-sm:grid-cols-1  grid-cols-2 w-full sm:px-16 grid lg:grid-cols-3 xl:grid-cols-4"
                : "hidden"
            }
