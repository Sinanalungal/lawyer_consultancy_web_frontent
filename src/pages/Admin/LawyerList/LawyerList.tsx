...
const LawyerList: React.FC = () => {
  ...
  return (
    <AdminLayout selected='2'>
      <AdminPageTitle title='Lawyers' description='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s,'/>
      <ItemTable
        columns={columns}
        data={data}
