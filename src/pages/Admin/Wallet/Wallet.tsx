            ...
            <div className="p-4">
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button className="w-full border border-gray-400 text-gray-700 py-2 rounded flex items-center justify-center">
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {transactions.length === 0 ? (
                      ...
                      transactions.map((tx) => (
                        <tr key={tx.pk} className="border-b text-[13px] hover:bg-gray-50">
                          <td className="p-2">
                          ...
                          {/* <td className="p-2">{tx.description || "N/A"}</td> */}
                        </tr>
                      ))
                    )}
                  </tbody>
...
//             <p className="text-lg font-medium text-gray-500 max-[400px]:text-base text-center max-sm:text-lg">
//               Available Balance
//             </p>
//             <p className="text-5xl max-sm:text-3xl font-bold text-black mt-4">
//               ₹{balance}
//             </p>
//           </div>
