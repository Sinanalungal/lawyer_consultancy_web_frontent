...
import SuccessPage from "../pages/User/SuccessFailPages/SuccessPage";
import FailPage from "../pages/User/SuccessFailPages/FailPage";

const AvailableLawyerSessions = lazy(() =>
  import("../pages/User/LawyerSessions/AvailableLawyerSessions")
);
const UserAppointments = lazy(() =>
  import("../pages/User/Appointment/UserAppointments")
);
const ClientPostCase = lazy(() => import("../pages/User/CaseManage/ApplyCase"));
const OngoingCases = lazy(() =>
  import("../pages/User/CaseManage/OngoingCases")
);
const WalletPage = lazy(() => import("../pages/Lawyer/Wallet/Wallet"));
const LawyerListing = lazy(() =>
  import("../pages/User/LawyerListing/LawyerListing")
);
      ...
      <Routes>
        <Route path="*" element={<UserPrivateRoute />}>
          ...
          <Route
            ...
            element={<AvailableLawyerSessions />}
          />
          ...
          <Route path="available-sessions/success" element={<SuccessPage />} />
          <Route path="available-sessions/fail" element={<FailPage />} />
        </Route>
      </Routes>
    </Suspense>
  );
