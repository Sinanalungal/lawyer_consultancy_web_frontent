...
const SavedAndLikedBlogs = lazy(() =>
  import("../pages/Common/SavedAndLikedBlogs/SavedAndLikedBlogs")
);
const NotificationSocket = lazy(() =>
  import("../components/Common/NotificationSocket")
);
